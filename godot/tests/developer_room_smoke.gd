...
func _run() -> void:
	...
	_expect(is_equal_approx(DeveloperResonanceRenderer._lissajous_clock(lissajous_period * 2.0, lissajous_group) - DeveloperResonanceRenderer._lissajous_clock(0.0, lissajous_group), TAU), "Lissajous runner completes one parameter cycle per two cascade periods")
